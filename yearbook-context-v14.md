...
### Реферальная система (приоритет — высокий, следующая задача)
...
### Редизайн UI (сделано 12.04)
- Главная страница альбомов — вариант А «чистый минимализм»
- Карточки альбомов с иконкой-кружком, тонким прогресс-баром, крупным %
- Табы внутри альбома — подчёркивание вместо синих кнопок
- Кнопки — тёмная основная, цветные акценты через фон
- Карточки статистики — число 4xl, метки серые
- Прогресс-бар — тёмный / зелёный при 100%

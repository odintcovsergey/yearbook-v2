...
# Версия: v86
# Обновлено: 18.05.2026 (РЭ.21.7.5 закрыт целиком — 3 коммита:
#   API rule_preset_create/update принимает density → UI density-dropdown
#   внутри секции students (B-стиль) → отображение density в PresetCard
#   под секцией students. Параметры внутри секций (B-стиль на старте):
#   UI представляет density как параметр секции, физически — preset.density.)
#

...
# CRM v1 запущен (клиенты, канбан-воронка, задачи).
# Все фото в Yandex Object Storage, Supabase на Free Plan.
...
**1. CRM — развитие (фазы 3+4)**
- Контакты в карточке клиента (директора, завучи) — API готов, UI не сделан
- Создание альбома прямо из сделки (кнопка в карточке сделки → AlbumFormModal)
- Настройка этапов воронки (переименовать, изменить цвет, поменять порядок)
- Допродажи: механики предложения доп. продуктов в карточке сделки

        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Дизайн — общий визуальный стиль альбома (например «Сказочный для
              садиков» или «Школьный строгий»). Шаблон — структура альбома
              (секции, число страниц, размещение). Здесь дизайны показаны с их
              шаблонами для удобства, но <strong>в заказе шаблон и дизайн
              выбираются отдельно</strong> — одну структуру можно применить к
              любому дизайну.
            </p>
          </div>
          <button

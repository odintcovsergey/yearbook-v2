...
# Версия: v61
# Обновлено: 16.05.2026 (IDML v2 от Сергея загружен — spec v1.3, ТЗ v1.5, Combined уточнены M=2/L=3/N=4)
#
...
# Сергей прислал IDML «Белыи плотные разворотами1» с 30 мастерами (включая 3 Combined).
# Парсер прошёл чисто. Combined-мастера имеют МЕНЬШЕЕ число слотов чем полные сетки:
# M-Combined=2, L-Combined=3, N-Combined=4. Это отдельный продуктовый вид страницы для
# маленького остатка учеников (1..N) + общее фото, не «обрезанная полная сетка».

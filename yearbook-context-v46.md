...
#
# ТЕКУЩАЯ РАБОТА: фаза А (общий раздел альбома) — стартует 11.05.2026
# после согласования F5 (виртуальные страницы) и поправки А.3
# (виньетки = существующие student_grid мастера). Первый подэтап
# А.1 в работе: расширение photos.type + UI загрузки 5 категорий

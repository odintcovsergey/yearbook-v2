...
# Версия: v81
# Обновлено: 18.05.2026 (полный день архитектуры:
#   rollback РЭ.20.6.3 → инвентаризация → РЭ.21 БД + UI просмотра +
#   создание пресета. Финальное направление зафиксировано:
#   template_set ⊕ preset.section_structure ⊕ редактор разворота)
#
...
#   ⚠️ Поле total_pages → переделать в диапазон min_pages + max_pages
#      (например, Мини: 6-6 фиксированный; Стандарт: 20-50).
#      Фактическое число на альбом — отдельное поле albums.total_pages.
...
#   1. РЭ.21.5 — min_pages/max_pages вместо total_pages.
#      Миграция БД + обновление формы + просмотр диапазона.

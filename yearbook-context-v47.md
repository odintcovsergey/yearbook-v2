...
# В работе А.2 — builder использует фото общего раздела при
# smart-fill (~1.5 дня). После А.2 идут А.4 (UI настройки
# разворотов общего раздела) и А.3 (виньетки в Индивидуальных).
#

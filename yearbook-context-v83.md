...
# Версия: v83
# Обновлено: 18.05.2026 (РЭ.21.5.3:
#   total_pages удалён из БД и кода. Sergei применил DROP COLUMN раньше
#   запланированного, прод подхватил срочным fix-коммитом fb69a30.
#   Диапазон min_pages/max_pages — единственный источник правды.)
#
...
#   1. РЭ.21.6 — template_set_id у пресета.
...
#   2. РЭ.21.7 — редактор структуры пресета.
#      Кнопка «Редактировать» на карточке. Drag-and-drop секций + слотов.
#      POST action rule_preset_update.
#   3. РЭ.21.8 — подключение section_structure к build engine.
...
#   4. РЭ.21.9 — копирование глобального пресета как стартового.
#      Кнопка «Скопировать как мой» на карточке глобального пресета.
#   5. РЭ.21.10 — финальная документация архитектуры.
#

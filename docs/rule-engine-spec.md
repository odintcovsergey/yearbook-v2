...
**Версия:** 1.1
**Дата:** 15.05.2026 (обновление после ревью Сергея)
**Статус:** утверждённая спецификация после 3 раундов проверки решений
...
| `student-section` | Личный раздел учеников **с параметром density** | Основная часть альбома | E-Student-* (Maximum/Universal/Standard варианты), L-Grid-Page, N-Grid-Page, M-Grid-Page |
